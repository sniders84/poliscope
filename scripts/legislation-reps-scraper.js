...
// Full replacement: fetch LegiScan bulk dataset, diagnostic logging, and enrichment of representatives-rankings.json
...
async function fetchAndParse() {
  console.log(`Downloading LegiScan bulk dataset for session ${SESSION} (House legislation)...`);
