...
function renderCards(data, containerId) {
  ...
  if (!container) {
    console.warn(`Missing container: ${containerId} — creating one automatically.`);
    container = document.createElement('div');
    container.id = containerId;
    container.className = 'card-container';
    // Try to append to likely parents: main sections
    const rankings = document.getElementById('rankings') || document.getElementById('my-officials') || document.body;
    rankings.appendChild(container);
  }
